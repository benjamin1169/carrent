            ...
            <div class="col-9  text-right">
              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  ...
                  <li class=""><a href="contact.php" class="nav-link"><u>Contact</u></a></li>
        ...
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-lg-6 text-center">
              <h1>Contact Us</h1>
              <p>Reach out to us if anything by filling the form below</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="site-section bg-light" id="contact-section">
      <div class="container">
        ...
        <div class="col-7 text-center mb-5">
          ...
          <p>Contact us by filling this form and we will get back to you in no time </p>
        </div>
      </div>
        <div class="row">
            ...
            <div class="bg-white p-3 p-md-5">
              ...
              <ul class="list-unstyled footer-link">
                <li class="d-block mb-3">
                  ...
                  <span>New Terminal 3, Adjacent Airport Shell, Accra</span></li>
                <li class="d-block mb-3"><span class="d-block text-black">Phone:</span><span>+233 20 814 7010</span></li>
                <li class="d-block mb-3"><span class="d-block text-black">Email:</span><span>accra@stmichaelrentacar.com</span></li>
              </ul>
            </div>
          </div>
        </div>
