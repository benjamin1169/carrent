  ...
  <section class="section main-section">
    <div class="card mb-6">
      ...
      <div class="card-content">
        <form method="POST" action="../../../actions/addandeditcategory.php" enctype="multipart/form-data">
            ...
            <div class="field-body">
              <div class="field">
                <div class="control icons-left">
                  <input class="input" type="text" name="categoryname" placeholder="Choose Service Category">
              ...
              <div class="field grouped">
                <div class="control">
                  <button type="submit" name="AddCategory" class="button green">
                    Add Category
                  </button>
                </div>
