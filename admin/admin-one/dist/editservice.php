...
// echo "Hello";
// echo $service_id;
$onecat= select_one_service_controller($service_id); 
// print_r($onecat);
?>
    ...
    <ul class="menu-list">
      ...
      <!-- <li class="active">
        <a href="editservice.php">
          <span class="icon"><i class="mdi mdi-square-edit-outline"></i></span>
          <span class="menu-item-label">Edit Services</span>
        </a>
      </li> -->
...
<section class="is-hero-bar">
  ...
  <section class="section main-section">
    <div class="card mb-6">
      ...
      <form method="POST" action="../../../actions/serviceaddedit_process.php" enctype="multipart/form-data">
            ...
            <div class="field-body">
              <div class="field">
                <div class="select icons-left">
                  <!-- <input class="input" type="text" name="service_cat" placeholder="Choose Service Category"> -->
                  <select name="service_cat" id="">
                    <option value="<?php echo $onecat['service_cat']?>" selected><?php echo $onecat['cat_name']?></option>
                    <?php
                      $cat = select_all_cat_controller();
              ...
              <div class="field-body">
                <div class="field">
                  <div class="control icons-left">
                    <input class="input" type="text" name="service_name" value="<?php echo $onecat['service_name'] ?>" placeholder="Choose Service Name">
          ...
          <div class="field">
            ...
            <div class="control">
              <textarea class="textarea" name="service_desc" placeholder="Standard features"><?php echo $onecat['service_desc']?></textarea>
            </div>
          </div>
          ...
          <label class="label">Keywords</label>
                <div class="field-body">
                  <div class="field">
                    <div class="control icons-left">
                      <input class="input" type="text" name="service_keywords" value="<?php echo $onecat['service_keywords'] ?>"placeholder="Keywords">
          ...
          <div class="field grouped">
            <div class="control">
              <button type="submit" name="EditButton" class="button green">
              Edit Service   
              </button>
            </div>
