        ...
        <div class="navbar-end">
          <div class="navbar-item dropdown has-divider">
            ...
            <div class="navbar-dropdown">
              ...
              <a class="navbar-item" href="../../../settings/core.php?logout=true">
          ...
          <a title="Log out" class="navbar-item desktop-icon-only" href="../../../settings/core.php?logout=true">
            <span class="icon"><i class="mdi mdi-logout"></i></span>
            <span>Log out</span>
          </a>
        </div>
      ...
      <div class="menu is-menu-main">
        ...
        <ul class="menu-list">
          ...
          <li class="--set-active-forms-html">
            ...
            <li class="--set-active-forms-html">
        <a href="addeditcatform.php">
          <span class="icon"><i class="mdi mdi-square-edit-outline"></i></span>
          <span class="menu-item-label">Category Form</span>
        </a>
      </li>
      <li class="--set-active-forms-html">
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td data-label="Name"><?php echo $x['customer_name'] ?></td>
                  <td data-label="Company"><?php echo $x['customer_email'] ?></td>
                  <td data-label="City"><?php echo $x['customer_contact'] ?></td>
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <div class='card-body'>
                  <td data-label="Image"><img style='height: 100px; width: 100px' src='../../<?php echo $x['service_image'] ?>' alt='Card image cap'>
                  <td data-label="Category"><?php echo $x['service_cat'] ?></td>
                  <td data-label="Name"><?php echo $x['service_name'] ?></td>
                  <td data-label="Price"><?php echo $x['service_price'] ?></td>
                  <td data-label="Description"><?php echo $x['service_desc'] ?></td>
                  <td data-label="Keyword"><?php echo $x['service_keywords'] ?></td>
                  ...
                  <td class="actions-cell">
                    <div class="buttons right nowrap">
                      <a href="./editservice.php?eid=<?php echo $x['service_id'] ?>">
                      <button class="button small green --jb-modal" data-target="sample-modal-2" type="button">
                        <span class="icon"><i class="mdi mdi-pencil"></i></span>
                      </button>
                    </a>
                    <a href="../../../actions/serviceaddedit_process.php?delete_id=<?php echo $x['service_id'] ?>">
    ...
    <!-- <div id="sample-modal" class="modal">
      ...
      <div class="modal-card">
        ...
        <section class="modal-card-body">
          <p>Make changes to this service<b>Click confirm if yes</b></p>
