...
$appointments = display_booking($_SESSION['user_id']);
?>
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td data-label="Customer"><?php echo $x['customer_id'] ?></td>
                  <td data-label="Service"><?php echo $x['service_name'] ?></td>
                  <td data-label="Category"><?php echo $x['cat_name'] ?></td>
                  <td data-label="Appointment Date"><?php echo $x['app_date'] ?></td>
                  <td data-label="Appointment Time"><?php echo $x['app_time'] ?></td>
          
                  
                  <!-- <td class="actions-cell">
                    <div class="buttons right nowrap">
                      <button class="button small green --jb-modal" name=data-target="sample-modal-2" type="button">
