    ...
    <div class="card mb-6">
      ...
      <form method="POST" action="../../../actions/serviceaddedit_process.php" enctype="multipart/form-data">
              ...
              <div class="field-body">
                <div class="field">
                  <div class="control icons-left">
                    <input class="input" type="text" name="service_name" placeholder="Choose Service Name">
                ...
                <div class="field-body">
                  <div class="field">
                    <div class="control icons-left">
                      <input class="input" type="number" name="service_price" placeholder="require_once service price"> 
                    </div>
                  </div>
                  </div>
          ...
          <div class="field">
            ...
            <div class="control">
              <textarea class="textarea" name="service_desc" placeholder="Standard features"></textarea>
            </div>
          </div>
          ...
          <label class="label">Keywords</label>
                <div class="field-body">
                  <div class="field">
                    <div class="control icons-left">
                      <input class="input" type="text" name="service_keywords" placeholder="Keywords">
          ...
          <div class="field grouped">
            <div class="control">
              <button type="submit" name="addButton" class="button green">
              Add Service
